...
#define foreach_edge(__node, __iterator) \
  ...
  virtual This* clone() {
    KExtensionOptTree *rt = new KExtensionOptTree(this->root_);
    rt->k_ = k_;
    rt->row_ = row_;
  ...
  int min_distance() {
    ...
    //std::cout << "min: distance: " << min_distance << ", " << min_s << std::endl;
    return min_distance;
  }
  ...
  int min_edit_prefix_update_suffix(Sequence &s_update) {
    Sequence suffix(s_update.begin() + row_, s_update.end());
    row_ = s_update.size();
    update_suffix(suffix);
    return min_prefix_distance_;
  ...
  int min_edit_prefix_update(Element e) {
    row_++;
    update_element(e);
    return min_prefix_distance_;
  }

  void update_element(Element e) {
...
: public RadixTree<Sequence, Element> {
 ...
 public:
  ...
  //typedef boost::unordered_map<EdgeOffset, int, EdgeOffsetHash> EdgeOffsetMap;
  typedef boost::unordered_map<EdgeOffset, int> EdgeOffsetMap;
  //typedef std::map<EdgeOffset, int> EdgeOffsetMap;
  typedef typename EdgeOffsetMap::iterator EdgeOffsetMapIterator;
  typedef typename EdgeOffsetMap::value_type EdgeOffsetMapValue;
...
#define foreach_edge(__node, __iterator) \
  ...
  virtual This* clone() {
    KExtensionTree *rt = new KExtensionTree(this->root_);
    rt->k_ = k_;
    rt->row_ = row_;
    rt->min_prefix_distance_ = min_prefix_distance_;
    rt->new_min_prefix_distance_ = INT_MAX;
  ...
  int min_distance() {
    ...
    //std::cout << "min: distance: " << min_dist<< ", " << min_s << std::endl;
    return min_dist;
  }
