...
#define LIB_CLIVER_ADDRESSSPACEGRAPH_H_
...
friend class AddressSpaceGraphVisitor;
 ...
 public:
  explicit AddressSpaceGraph(klee::ExecutionState *state);
  void build();
  void process();
  ...
  void extract_pointers_by_resolving(klee::ObjectState *obj,
                                     PointerList &results);
...
#endif  // LIB_CLIVER_ADDRESSSPACEGRAPH_H_
