...
//===----------------------------------------------------------------------===//
//
// This file defines the CliverFunctionHandler interface. It is closedly based
// on klee::FunctionHandler. The purpose of this interface is to provide access
// to Cliver methods from within symbolically executing code. Function calls
// are intercepted during symbolic execution if the function name has declared
// handler here. This interface is intended to be used by both the client
// application as well as modelled OS or system libraries. 
//
//===----------------------------------------------------------------------===//
